...
import ListarProdutosOferta from "../Components/ListaProdutosOferta";

export default function Oferta() {
  const [listaProdutos] = useState([
    {
      id: 1,
      item: "Alto-falante Bluetooth Divoom Ditoo Pixel Art",
      imagem: "https://divoom.com/cdn/shop/products/ditoo-pro-1_6bd4822c-21b9-4eb4-9c77-f05bc861a0cd.jpg?v=1722318494&width=800",
      precoOriginal: "R$ 550,50",
      precoDesconto: "R$500,00",
      maisvendido: false,
      temled: false,
    ...
    },
    {
      ...
      precoOriginal: "R$ 99,50",
      precoDesconto: "R$59,00",
      maisvendido: true,
      temled: false,
      cor: ["branco", "preto"],
      marca: "Oex"
    },
    {
      ...
      maisvendido: true,
      temled: true,
      precoOriginal: "R$ 1.231,88",
      precoDesconto: "R$1.000,00",
    ...
    },
    {
      ...
      maisvendido:true,
      temled:true,
      precoOriginal: "R$ 1.550,50",
      precoDesconto: "R$1.250,00",
  ...
  },
  {
    ...
    precoOriginal: "R$ 1.988,50",
    precoDesconto: "R$1.300,00",
    maisvendido: false,
    temled: false,
...
},
{
    ...
    precoOriginal: "R$ 3.550,50",
    precoDesconto: "R$ 1.500,00",
    maisvendido: true,
    temled: false,
    cor: ["Branco"],
    marca: "Nintendo"
  ...
  return (
    <main>
      ...
      <ListarProdutosOferta produtosoferta={listaProdutos} />
